		...
		<div class="wcpt-nm-content wcpt-noselect">
			<div class="wcpt-nm-heading wcpt-nm-heading--sticky">
				...
				<span class="wcpt-nm-heading-text wcpt-on-filters-show">
					<?php echo !empty($strings['filters'][$locale]) ? esc_html($strings['filters'][$locale]) : esc_html__('Filters', 'wc-product-table'); ?>
				</span>
				<span class="wcpt-nm-heading-text wcpt-on-sort-show">
					<?php echo !empty($strings['sort'][$locale]) ? esc_html($strings['sort'][$locale]) : esc_html__('Sort', 'wc-product-table'); ?>
				</span>
				<div class="wcpt-nm-action">
					<span class="wcpt-nm-reset">
						<?php echo (!empty($strings['reset']) && !empty($strings['reset'][$locale])) ? esc_html($strings['reset'][$locale]) : esc_html__('Reset', 'wc-product-table'); ?>
					</span>
					<span class="wcpt-nm-apply">
						<?php echo (!empty($strings['apply']) && !empty($strings['apply'][$locale])) ? esc_html($strings['apply'][$locale]) : esc_html__('Apply', 'wc-product-table'); ?>
					</span>
				</div>
			</div>

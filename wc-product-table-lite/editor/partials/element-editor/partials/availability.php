...
<div class="wcpt-editor-row-option">
  ...
  <div wcpt-model-key="out_of_stock_message" wcpt-be-add-row="0" wcpt-block-editor></div>
</div>

<!-- single product left -->
<div class="wcpt-editor-row-option">
  <label>"Only 1 product left in stock" message</label>
  <div wcpt-model-key="single_stock_message" wcpt-be-add-row="0" wcpt-block-editor></div>
</div>
...
<!-- low stock -->
<div class="wcpt-editor-row-option" wcpt-panel-condition="prop" wcpt-condition-prop="low_stock_threshold"
  wcpt-condition-val="!0">
  <label>
    "Low stock left" message
    <small>Use the [stock] shortcode</small>
  </label>
  <div wcpt-model-key="low_stock_message" wcpt-block-editor wcpt-be-add-row="0"></div>
</div>
...
<div class="wcpt-editor-row-option">
  ...
  <div wcpt-model-key="in_stock_message" wcpt-block-editor wcpt-be-add-row="0"></div>
</div>
...
<div class="wcpt-editor-row-option">
  ...
  <div wcpt-model-key="in_stock_managed_message" wcpt-block-editor wcpt-be-add-row="0"></div>
</div>
...
<div class="wcpt-editor-row-option">
  ...
  <div wcpt-model-key="on_backorder_message" wcpt-block-editor wcpt-be-add-row="0"></div>
</div>

...
<div class="wcpt-editor-row-option">
  ...
  <label wcpt-panel-condition="prop" wcpt-condition-prop="click_action" wcpt-condition-val="trigger_filter">
    <small>
      Note: This option requires you to have the corresponding navigation filter element setup in your table navigation
      section.
    </small>
  </label>
</div>
...
<div class="wcpt-editor-row-option">
  ...
  <label>
    <small>Shows each tag in a rounded bubble. Separator is not used in this mode.</small>
  </label>
</div>

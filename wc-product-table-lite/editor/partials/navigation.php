<div class="wcpt-nav-device" wcpt-controller="laptop_navigation" wcpt-model-key="laptop">
  ...
  <div class="wcpt-left-sidebar-settings">
    ...
    <div wcpt-model-key="left_sidebar" wcpt-block-editor="" wcpt-be-add-element-partial="add-navgiation-header-element"
      ...
      wcpt-be-add-row="0" wcpt-initial-data="nav_left_sidebar"></div>
  ...
  <div class="wcpt-header-settings" wcpt-model-key="header">
    ...
    <div class="wcpt-sortable wcpt-header-rows-wrapper" wcpt-controller="header_rows" wcpt-model-key="rows">
      <!-- header row -->
      <div class="wcpt-nav-editor-row" wcpt-controller="nav_header_row" wcpt-model-key="[]" wcpt-model-key-index="0"
        ...
        <!-- textarea options -->
        <div class="wcpt-editor-row-option wcpt-editor-filter-row-options wcpt-editor-header-textareas-container"
          ...
          <div class="wcpt-editor-left-column-input-wrapper wcpt-editor-header-textarea-wrapper" wcpt-model-key="left">
            <div wcpt-model-key="template" wcpt-block-editor wcpt-be-add-element-partial="add-navgiation-header-element"
              wcpt-be-connect-with=".wcpt-editor-tab-navigation [wcpt-model-key='laptop'] .wcpt-block-editor-row"
              wcpt-be-add-row="0"></div>
          </div>

          <!-- center column -->
          <div class="wcpt-editor-center-column-input-wrapper wcpt-editor-header-textarea-wrapper"
            wcpt-model-key="center">
            <div wcpt-model-key="template" wcpt-block-editor wcpt-be-add-element-partial="add-navgiation-header-element"
              wcpt-be-connect-with=".wcpt-editor-tab-navigation [wcpt-model-key='laptop'] .wcpt-block-editor-row"
              wcpt-be-add-row="0"></div>
          </div>
          ...
          <!-- right column -->
          <div class="wcpt-editor-right-column-input-wrapper wcpt-editor-header-textarea-wrapper"
            wcpt-model-key="right">
            <div wcpt-model-key="template" wcpt-block-editor wcpt-be-add-element-partial="add-navgiation-header-element"
              wcpt-be-connect-with=".wcpt-editor-tab-navigation [wcpt-model-key='laptop'] .wcpt-block-editor-row"
              wcpt-be-add-row="0"></div>
          </div>
